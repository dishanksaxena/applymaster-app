...
export default function JobsPage() {
  ...
  return (
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8 max-w-[1200px] mx-auto">
      ...
      {/* Search */}
      <motion.div variants={fadeUp} className="p-6 rounded-2xl" style={{ background: 'linear-gradient(135deg, #252545 0%, #1e1e3a 100%)', border: '1px solid rgba(255,255,255,0.15)' }}>
