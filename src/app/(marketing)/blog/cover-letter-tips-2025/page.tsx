    ...
    <>
      ...
      <main className="min-h-screen bg-[var(--bg)] text-ink">
        <article className="max-w-3xl mx-auto px-6 py-24">
          ...
          <Link
            href="/blog"
            className="text-sm text-[var(--blue)] hover:text-[var(--blue)] font-medium mb-8 inline-block"
          >
            &larr; Back to Blog
          </Link>
          ...
          <header className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              <span className="px-3 py-1 rounded-full text-xs font-semibold bg-[var(--blue-dim)] text-[var(--blue)]">
                Cover Letters
              </span>
              <time className="text-xs text-[var(--text-faint)]" dateTime="2025-03-20">
                March 20, 2025
              </time>
          ...
          <nav className="mb-12 p-6 rounded-xl border border-[var(--border)] bg-[var(--bg-overlay)]">
            <h2 className="text-sm font-semibold text-[var(--blue)] uppercase tracking-wider mb-4">
              Table of Contents
            </h2>
          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <ul className="space-y-3 text-[var(--text-secondary)]">
                <li>
                  <strong className="text-ink">Paragraph 1 &mdash; The Hook (2-3 sentences):</strong>{' '}
                  Why this specific company and role excites you. Demonstrate that you have done
                  your research.
                </li>
                <li>
                  <strong className="text-ink">Paragraph 2 &mdash; The Evidence (3-4 sentences):</strong>{' '}
                  Your strongest 1-2 achievements that directly relate to what the job requires.
                  Use numbers.
                </li>
                <li>
                  <strong className="text-ink">Paragraph 3 &mdash; The Close (2 sentences):</strong>{' '}
            ...
            {/* Section 3 */}
            <section>
              <h2 className="text-2xl font-bold text-ink mb-4">3. Paragraph 1: The Hook</h2>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              <h3 className="text-lg font-semibold text-ink mb-3">What Does Not Work</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              <h3 className="text-lg font-semibold text-ink mb-3">What Works</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              <p className="text-[var(--text-secondary)] leading-relaxed">
                ...
                mission. If you can explain <em className="text-ink">why</em> you want this
            ...
            {/* Section 4 */}
            <section>
              <h2 className="text-2xl font-bold text-ink mb-4">4. Paragraph 2: The Evidence</h2>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              <ul className="space-y-3 text-[var(--text-secondary)]">
                <li>
                  <strong className="text-ink">Use the STAR micro-format.</strong> In 2-3
                  sentences, describe the Situation, Task, Action, and Result. Keep it tight and
                  quantified.
                </li>
                <li>
                  <strong className="text-ink">Match the job description.</strong> If the posting
                ...
                <li>
                  <strong className="text-ink">Use specific numbers.</strong> &quot;Increased
                  conversion by 34%&quot; beats &quot;significantly improved conversion.&quot;
                  Numbers make claims credible and memorable.
                </li>
                <li>
                  <strong className="text-ink">Focus on impact, not duties.</strong> &quot;I was
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-2xl font-bold text-ink mb-4">5. Paragraph 3: The Close</h2>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                End with confidence, not desperation. Two sentences is all you need:
              </p>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
                <strong className="text-ink">Sentence 1:</strong> A forward-looking statement
              ...
              <p className="text-[var(--text-secondary)] leading-relaxed">
                <strong className="text-ink">Sentence 2:</strong> A call to action. &quot;I would
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-ink mb-3">What AI Does Well</h3>
              <ul className="space-y-2 text-[var(--text-secondary)] mb-4">
                ...
                <li>Ensuring proper keyword inclusion for{' '}
                  <Link href="/blog/ats-resume-optimization" className="text-[var(--blue)] hover:underline">
                    ATS optimization
                  </Link>
                </li>
              </ul>
              <h3 className="text-lg font-semibold text-ink mb-3">What AI Needs Help With</h3>
              <ul className="space-y-2 text-[var(--text-secondary)] mb-4">
            ...
            <section>
              ...
              <ul className="space-y-3 text-[var(--text-secondary)]">
                <li>
                  <strong className="text-ink">Length:</strong> 150-250 words, never exceeding one
                  page. Three paragraphs maximum.
                </li>
                <li>
                  <strong className="text-ink">Font:</strong> Same professional font as your
                  resume (Arial, Calibri, or similar), 10-12pt size.
                </li>
                <li>
                  <strong className="text-ink">Margins:</strong> 1 inch on all sides. Standard
                  business letter format.
                </li>
                <li>
                  <strong className="text-ink">File format:</strong> PDF to preserve formatting.
                ...
                <li>
                  <strong className="text-ink">Subject line (email):</strong> If sending via
            ...
            <section>
              ...
              <ul className="space-y-3 text-[var(--text-secondary)]">
                <li>
                  <strong className="text-ink">The application explicitly says not to include
                  one.</strong> Respect the instructions. Sending one anyway can signal that you do
                  not follow directions.
                </li>
                <li>
                  <strong className="text-ink">LinkedIn Easy Apply with no upload option.</strong>{' '}
                  If the{' '}
                  <Link href="/blog/linkedin-auto-apply-guide" className="text-[var(--blue)] hover:underline">
                ...
                <li>
                  <strong className="text-ink">Time-sensitive applications where a generic
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-ink mb-3">Career Changer</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              <h3 className="text-lg font-semibold text-ink mb-3">Entry-Level / Recent Graduate</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              <h3 className="text-lg font-semibold text-ink mb-3">Senior / Executive Level</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed mb-4">
              ...
              <h3 className="text-lg font-semibold text-ink mb-3">Returning After a Gap</h3>
              <p className="text-[var(--text-secondary)] leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-3 text-[var(--text-secondary)]">
                <li>
                  <strong className="text-ink">Job description analysis.</strong> The AI reads
                  each job posting and identifies the key requirements, desired skills, and company
                  context.
                </li>
                <li>
                  <strong className="text-ink">Experience matching.</strong> It maps your profile
                  to the job requirements and selects the most relevant achievements to highlight.
                </li>
                <li>
                  <strong className="text-ink">Company research.</strong> The system pulls recent
                  company information to add genuine personalization that goes beyond the job
                  description.
                </li>
                <li>
                  <strong className="text-ink">Tone calibration.</strong> Whether the company
                ...
                <li>
                  <strong className="text-ink">Human review.</strong> Every generated cover letter
          ...
          {/* CTA Section */}
          <section className="mt-16 p-8 md:p-12 rounded-2xl border border-[var(--border)] bg-gradient-to-br from-[var(--blue-dim)] to-transparent text-center">
            ...
            <Link
              href="/signup"
              className="inline-block px-8 py-4 bg-[var(--blue)] hover:bg-[var(--blue)] text-[var(--text-on-accent)] font-semibold rounded-xl transition-colors"
            >
          ...
          <nav className="mt-12 pt-8 border-t border-[var(--border)]">
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/blog/ats-resume-optimization" className="text-[var(--blue)] hover:underline text-sm">
                  ATS Resume Optimization: Beat the Bots &amp; Get Interviews
                </Link>
              </li>
              <li>
                <Link href="/blog/interview-preparation-guide" className="text-[var(--blue)] hover:underline text-sm">
                  AI Interview Coaching: Prepare for Any Interview in 30 Minutes
                </Link>
              </li>
              <li>
                <Link href="/blog/ai-job-application-guide" className="text-[var(--blue)] hover:underline text-sm">
