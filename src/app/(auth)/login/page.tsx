    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0f] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="p-8 rounded-2xl bg-[#12121a] border border-[rgba(255,255,255,0.06)] shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
          ...
          <p className="text-[14px] text-[#8a8a9a] mb-8">Sign in to your account to continue</p>
          ...
          {/* Google OAuth */}
          <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white text-[#0a0a0f] font-bold text-[14px] hover:bg-gray-100 transition-colors mb-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[12px] text-[#5a5a6a] font-medium">or continue with email</span>
            <div className="flex-1 h-px bg-[rgba(255,255,255,0.06)]" />
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-[12px] font-semibold text-[#8a8a9a]">Password</label>
                <Link href="/forgot-password" className="text-[11px] text-[#fd79a8] hover:underline font-semibold">Forgot password?</Link>
              </div>
              <input
                type="password"
                value={password}
        ...
        <p className="text-center text-[13px] text-[#5a5a6a] mt-6">
          ...
          <Link href="/signup" className="text-[#fd79a8] font-semibold hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  )
