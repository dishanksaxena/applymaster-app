    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg)] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="p-8 rounded-2xl bg-[var(--bg-card)] border border-[var(--bg-overlay)] shadow-[0_40px_100px_rgba(0,0,0,0.5)]">
          ...
          {/* Google OAuth */}
          <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-white text-[var(--bg)] font-bold text-[14px] hover:bg-gray-100 transition-colors mb-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-[12px] text-[var(--text-faint)] font-medium">or continue with email</span>
            <div className="flex-1 h-px bg-[var(--bg-overlay)]" />
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[var(--accent)] to-[var(--accent-solid)] text-ink font-bold text-[14px] hover:shadow-[0_8px_30px_rgba(253,121,168,0.3)] hover:translate-y-[-1px] transition-all disabled:opacity-50"
            >
        ...
        <p className="text-center text-[13px] text-[var(--text-faint)] mt-6">
          ...
          <Link href="/signup" className="text-[var(--accent)] font-semibold hover:underline">Sign up free</Link>
        </p>
      </div>
    </div>
  )
